...
// material
import { withStyles, useTheme, alpha, experimentalStyled as styled } from '@material-ui/core/styles';
import {
  Box,
  List,
  Link,
...
const PDFToolButton = withStyles((theme) => ({
  root: {
...
export default function HomeNavbar() {
  ...
  const renderMenuMobile = (
    <MenuPopover disablePortal open={openMenu} anchorEl={anchorRef.current} onClose={() => setOpenMenu(false)}>
      <List>
        {MENU_LINKS.map((link) => (
          <MenuItem
            exact
          ...
          >
            ...
            <ListItemText primaryTypographyProps={{ typography: 'body2' }}>{link.title}</ListItemText>
          </MenuItem>
        ))}
      </List>
    </MenuPopover>
      ...
      <RootStyle color="transparent">
        ...
        >
          ...
          >
            ...
            <MHidden width="mdDown">{renderMenuDesktop}</MHidden>
            ...
            <MHidden width="mdDown">
              <PDFToolButton variant="contained" size="small">
                All PDF Tools
              </PDFToolButton>
            </MHidden>
